...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
 ...
 GOPAY: 082142961010 / QR CHAT OWNER
AN: Radja wali`
...
Wa.me/${setting.owner}`
   sendButMessage(from, titid, `Save Nomor Bot☜☆☞ `, [
      ...
      case 'payment':
               list = []
               listmenu = [`qris`,`dana`,`gopay`]
               listmenuu = [`BAYAR DENGAN QRIS`,`BAYAR DENGAN DANA`,`BAYAR DENGAN GOPAY`,`INFO BISNIS`,]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
...
📱*HANYA KHUSUS MEMBER/USER PREMIUM*
`
   sendButMessage(from, wibu, `Save Nomor Bot☜☆☞`, [
          {
            buttonId: `${prefix}menu`,
